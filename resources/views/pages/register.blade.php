...
<div class="container">
    <form class="form-horizontal" role="form" method="POST" action="/register">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        <div class="input-group-addon" style="width: 2.6rem"><i class="fa fa-user"></i></div>
                        <input type="text" name="name" class="form-control" id="name"
                               placeholder="Dev" required autofocus>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        <div class="input-group-addon" style="width: 2.6rem"><i class="fa fa-user"></i></div>
                        <input type="text" name="name" class="form-control" id="name"
                               placeholder="jdev" required autofocus>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="number" age = 'age' class="form-control" id="age"
                               placeholder="Your age" required autofocus>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-control-feedback">
                        <span class="text-green align-middle">
                             [Must be at least 6 digits, Use upercase and lower case for more safety]
                        </span>
                </div>
            </div>
        </div>
